    ...
    return function () {
        ...
        1: [function (e, t, n) {
            ...
            t.exports = {
                ...
                render: function (e, t, n) {
                    ...
                    if (t)
                        t.appendChild(r);
                    if (i.backend && i.backend.name === "mathjax") {
                ...
                renderToString: function (e, t) {
                    if (e === null || e === undefined)
                        throw new ReferenceError("Input cannot be empty");
                    var n = a(e, t);
                    if (n.backend && n.backend.name === "mathjax" && n.backend.version < 3) {
                ...
                renderClass: function (e, t) {
                    [...document.getElementsByClassName(e)].forEach(e => this.renderElement(e, t))
                }
            }
        }, {
            "./src/Lexer": 2,
        ...
        2: [function (e, t, n) {
            ...
            r.prototype.expect = function (e, t) {
                ...
                if (n.type !== e) {
                    throw new u(`Expected an atom of ${e} but received ${n.type}`, this._pos, this._input)
                }
                if (!this._matchText(t)) {
                    throw new u(`Expected \`${t}\` but received \`${n.text}\``, this._pos, this._input)
                }
                this._next();
                return this._currentAtom.text
            };
            ...
            r.prototype._matchText = function (e) {
                ...
                if (i.isString(e))
                    ...
                    return e.some(e => e.toLowerCase() === this._nextAtom.text.toLowerCase())
            };
            t.exports = r
        }, {
            "./ParseError": 3,
        ...
        5: [function (n, e, t) {
                    ...
                    switch (n) {
                        ...
                        case "math":
                            if (typeof e === "undefined") {
                                ...
                                if (e.version === 3) {
                                    this._html.putHTML(e.driver.tex2chtml(i, {
                                        display: false
                                    }).outerHTML)
                                } else {
                                    this._html.putText(`$${i}$`)
                                ...
                                throw new EvalError(`Unknown math backend ${e}`)
                            }
                            break;
                        case "cond-symbol":
            ...
            function r(e) {
                ...
                this.scopeLines = e.scopeLines !== undefined ? e.scopeLines : false;
            ...
            F.prototype._newLine = function () {
                ...
                if (this._blockLevel > 0) {
                    ...
                    var t = this._options.lineNumber ? e * 1.25 : 0;
                    t += this._options.scopeLines ? e * .1 : 0;
                    if (this._options.lineNumber) {
                        this._html.beginSpan("ps-linenum", {
                            left: `${-((this._blockLevel - 1) * t)}em`
            ...
            F.prototype._buildTree = function (e) {
                ...
                switch (e.type) {
                    ...
                    case "algorithm":
                        ...
                        break;
                    case "algorithmic":
                        var o = this._options.lineNumber ? " with-linenum " : "";
                        o += this._options.scopeLines ? " with-scopelines " : "";
                        if (o) {
                            this._beginGroup("algorithmic", o);
                            this._numLOC = 0
                        } else {
                    ...
                    case "block":
                        ...
                        break;
                    case "function":
                        var s = e.value.type.toLowerCase();
                        var a = e.value.name;
                        i = e.children[0];
                        var l = e.children[1];
                        this._newLine();
                        this._typeKeyword(`${s} `);
                        this._typeFuncName(a);
                        this._typeText("(");
                        this._buildTree(i);
                        this._typeText(")");
                    ...
                    case "if":
                        ...
                        var h = e.children[1];
                        this._buildCommentsFromBlock(h);
                        this._buildTree(h);
                        var p = e.value.numElif;
                        for (var u = 0; u < p; u++) {
                            this._newLine();
                            this._typeKeyword("else if ");
                            var c = e.children[2 + 2 * u];
                            this._buildTree(c);
                            this._typeKeyword(" then");
                            var f = e.children[2 + 2 * u + 1];
                            this._buildCommentsFromBlock(f);
                            this._buildTree(f)
                        }
                        var d = e.value.hasElse;
                        if (d) {
                            this._newLine();
                            this._typeKeyword("else");
                            var _ = e.children[e.children.length - 1];
                    ...
                    case "statement":
                        ...
                        break;
                    case "open-text":
                        var E = new B(e.children, this._globalTextStyle);
                        this._html.putHTML(E.renderToHTML(this.backend));
                        break;
                    case "close-text":
                        var M = this._globalTextStyle.fontSize();
                        var $ = new A(M);
                        var z = new B(e.children, $);
        ...
        6: [function (e, t, n) {
            t.exports = {
                ...
                isObject: e => typeof e === "object" && e instanceof Object,
                toString: function (e) {
                    if (!this.isObject(e))
                        return `${e}`;
                    var t = [];
                    for (var n in e)
                        t.push(`${n}: ${this.toString(e[n])}`);
                    return t.join(", ")
                }
            }
        }, {}]
